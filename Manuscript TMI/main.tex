...
\midrule
\textbf{Proposed CQC-Net (CI-GCI)} & \textbf{IEEE TMI (Ours)} & \textbf{0.9337} & \textbf{0.8101} & \textbf{0.6780} \\
\bottomrule
\end{tabular}
\end{table}

As demonstrated in Table~\ref{tab:sota_benchmark}, CI-GCI outperforms the best published causal debiasing model (DE-CaGI \cite{liu2026decagi}) by +8.57\% on VQA-RAD (93.37\% vs. 84.80\%), +1.21\% on SLAKE (81.01\% vs. 79.80\%), and +2.70\% on PathVQA (67.80\% vs. 65.10\%). This significant margin confirms that replacing feature-level interventions with physical generative counterfactual inpainting effectively resolves persistent visual shortcuts that continue to limit prior SOTA models.
...
\textbf{Proposed Consistency Head} & \textbf{0.8350} & \textbf{0.8140} & \textbf{0.8240} & \textbf{0.9120} & \textbf{0.8840} & \textbf{0.1450} & \textbf{0.3820} & \textbf{0.0380} & \textbf{0.0650} \\
\bottomrule
\end{tabular}
\end{table}
...
\textbf{Proposed CQC-Net} & \textbf{0.8420} & \textbf{0.6540} & \textbf{0.7680} & \textbf{0.2140} & \textbf{0.7950} & \textbf{4.3500} \\
\bottomrule
\end{tabular}
\end{table}
...
\textbf{Proposed CQC-Net} & \textbf{4.5800} & \textbf{4.4100} & \textbf{4.6200} & \textbf{1.1200} & \textbf{0.7920} \\
\bottomrule
\end{tabular}
\end{table}

As shown in Table~\ref{tab:human_eval}, CI-GCI received an average Clinical Correctness score of 4.58 / 5.0 (vs. 3.42 for baselines), Image Grounding score of 4.41 / 5.0, and Helpfulness score of 4.62 / 5.0, while reducing Hallucination Severity to 1.12 / 5.0. Inter-rater agreement was high across all reviewers (Cohen's $\kappa = 0.792$, Fleiss' $\kappa = 0.768$).
...
\textbf{Proposed CQC-Net} & \textbf{0.1229} & \textbf{0.0920} & \textbf{0.0520} & \textbf{0.1650} & \textbf{0.0820} & \textbf{0.0240} \\
\bottomrule
\end{tabular}
\end{table}

Under the selective abstention rule \eqref{eq:abstain}, CI-GCI allows the model to refer uncertain cases to human radiologists. At operational threshold $\tau_2$, CI-GCI achieves a **2.40\% clinical error rate** at 72.50\% coverage (Risk @ $\tau_2 = 0.0240$), providing a reliable safety barrier for automated clinical workflows.
...
\midrule
\textbf{Full model} & \textbf{\checkmark} & \textbf{\checkmark} & \textbf{\checkmark} & \textbf{\checkmark} & \textbf{\checkmark} & \textbf{0.8101} & \textbf{0.7780} & \textbf{0.3840} & \textbf{0.7250} & \textbf{0.1420} & \textbf{0.9120} & \textbf{0.1229} \\
...
w/o Refiner & \checkmark & \checkmark & \checkmark & \text{\sffamily X} & \checkmark & 0.7720 & 0.7540 & 0.3520 & 0.6520 & 0.1420 & 0.9120 & 0.0420 \\
w/o Abstention & \checkmark & \checkmark & \checkmark & \checkmark & \text{\sffamily X} & 0.8101 & 0.7780 & 0.3840 & 0.7250 & 0.2740 & 0.7840 & 0.1180 \\
\bottomrule
\end{tabular}
\end{table*}
